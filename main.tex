...
Notice that there is a discrepancy between the job visualization in \Cref{fig:use_case} and the quantized job codings.
While in \Cref{cluster:use_case:hex_lev} we can see a less intensive phase in the beginning and a high intensive phase afterwards, the quantized coding contains a more or less single high intensive I/O phase.
