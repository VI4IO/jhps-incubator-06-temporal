...
For the B-algorithms and Q\_PHASES we chose a SIM of 0.7, and the other Q-algorithms SIM of 0.9.
...
Clustering with SIM=0.9 results in clusters that have equal job lengths.
From the definition of the equation, for a similarity of 90\% the centroid must be longer than 10 segments to attract jobs with 9 or 11 length.
Due to space restrictions, we could not visualize a representative example.
Instead of that we take a short one, which doesn't include all the typical characteristics.
...
\begin{figure}
	...
	\begin{subtable}{\textwidth}
      ...
      \begin{tabular}{ll|r}
        ...
        \rowcolor{tblhead}
        md\_file\_delete     &  md\_other & Type     \\ 
        \hline
        -:...:-              &  -:-:1:-   & centroid \\ 
        \multicolumn{3}{l}{} \\ 
        \rowcolor{tblhead}
        md\_file\_delete     &  md\_other & Count    \\ 
        \hline
        -:...:-              &  -:-:1:-   & 6,115     \\ 
        -:...:-              &  -:-:2:-   & 1,467     \\ 
        -:...:-              &  -:1:-:-   & 1,070     \\ 
	...
	\end{subfigure}
	\caption{Q\_NATIVE algorithm: Information of the selected cluster (SIM=0.9).}
