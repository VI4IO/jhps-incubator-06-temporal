...
\paragraph{Readability}   % English and structure appropriate?
In general the readability is good, although there are a number of places where the language could be improved or where text is not completely understandable. Comments have been added in the text outlining these issues.
